package org.gohub.golauncher.activities;
...
public class Preferences extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findPreference(PREFERENCE_ABOUT).setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				try {
					startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=org.gohub.golauncher")));
				} catch (Exception e) {
					e.printStackTrace();
					Toast.makeText(getApplicationContext(),
